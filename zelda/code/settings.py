...
UPGRQDE_BG_COLOR_SELECTED = '#EEEEEE'
...
#magic
magic_data = {
    'flame': {'strenght' : 5, 'cost' : 20, 'graphic': 'zelda/graphics/particles/flame/fire.png'},
    'heal': {'strenght' : 20, 'cost' : 10, 'graphic': 'zelda/graphics/particles/heal/heal.png'}}
