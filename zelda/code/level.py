...
class Level:
    ...
    def create_map(self):
        layouts = {
            ...
            'object': import_csv_layout('zelda/map/map_Objects.csv'),
...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        # creating the floor
        self.floor_surf = pygame.image.load('zelda/graphics/tilemap/ground.png').convert()
